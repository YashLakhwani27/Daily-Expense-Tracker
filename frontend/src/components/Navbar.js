    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        <li className="nav-item">
         <Link className="nav-link active" aria-current="page" to="/"><i className='fas fa-home me-2'></i>Home</Link>
        </li>
        ...
        <li className="nav-item">
         <Link className="nav-link" to="/add-expense"><i className='fas fa-sign-in-alt me-1'></i>Add Expense</Link>
        </li>
        <li className="nav-item">
